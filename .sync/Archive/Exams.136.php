    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
                                    ...
                                    <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable">
                                        <form action="process.php" method="POST" id="formsave" style="min-width:1550px;">
                                            ...
                                            <div class="input-group" style="padding-top: 20px;">
                                                ...
                                                <select class="form-control" id="dropcourse_title" required name="course_title">
                                                ...
                                                <select class="form-control" id="dropfaculty_title" required name="faculty_title">
                                                    <option value="">SELECT course title</option>
                                                    <?php
            ...
            <<?php
                ...
                <script>
                    var ddl = document.getElementById('dropcourse_title');
                    var opts = ddl.options.length;
                    var ddl2 = document.getElementById('dropfaculty_title');
