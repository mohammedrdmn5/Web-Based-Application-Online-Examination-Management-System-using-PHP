...
if (isset($_POST['update'])) {
    ...
    $conn->query("UPDATE Exam SET exam_title='$exam_title',exam_datetime='$exam_datetime',exam_duration='$exam_duration',total_question='$total_question',status='$status',course_id='$course_id',teacher_id=$teacher_id,faculty_title=$faculty_title,exam_code='$exam_code' WHERE exam_id=$exam_id") or die($con->error);
    session_start();
