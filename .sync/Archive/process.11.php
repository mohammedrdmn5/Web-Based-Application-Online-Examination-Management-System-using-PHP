...
if (isset($_POST['save'])) {
    ...
    $exam_title = $con->real_escape_string($_POST['exam_title']);
    $exam_datetime = $con->$_POST['exam_datetime'];
    $exam_duration = $con->real_escape_string($_POST['exam_datetime']);
    $total_question = $con->real_escape_string($_POST['total_question']);
