                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image" style="background-image: url(&quot;assets/img/1566798061-exam-online.png&quot;);"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                        <div class="form-group"><input class="form-control form-control-user" value="<?php echo $username; ?>" type="text" id="exampleInputuser" placeholder="Username" name="username"></div>
                                        <div class="form-group"><input class="form-control form-control-user" value="<?php echo $phone; ?>" type="number" id="exampleInputPassword" placeholder="Phone number" name="Phone"></div>
