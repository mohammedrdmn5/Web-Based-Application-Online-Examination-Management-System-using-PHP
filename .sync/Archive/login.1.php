...
<body>
    ...
    if (isset($_POST['Login'])) {
        ...
        $hash = sha1($_POST['password']);
                                          //////////////////////////////////////change
        $usercheck = mysqli_query($conn, "select username from smartiesproject.member where username='" . $username . "'");
        $passcheck = mysqli_query($conn, "select password_hash from smartiesproject.member where username='" . $username . "'");
