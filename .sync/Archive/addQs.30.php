                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    if (isset($_GET['search'])) {
                                        ...
                                        $searchResult = $conn->query("SELECT DISTINCT
                                            ...
                                            $count = 0;
                                        $row2 = $searchResult->fetch_assoc();
                                        $numberOfQs = $row2['total_question'][0];
                                        while ($row = $searchResult->fetch_assoc()) {
                                            ...
                                            echo '
                                                <tr>
                                                    <td>  <input type="text" name="exam_title" class="form-control" required placeholder="Enter exam title" value="' . $row['question_title'] . '"></td>
