                        ...
                        <div class="col-lg-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                                            <button class="btn btn-primary btn-sm" name="changepicture" type="submit">Change
                                                Photo</button>
                                            <input class="btn-primary" type="file" name="sfile" id="file"">
                            ...
                            function changePhoto()
                            {
                                if (isset($_POST['sfile'])) {
                                    ...
                                    $getimage = mysqli_query($conn, "select user_image from User where user_id='$user_id'") or die(mysqli_error($conn));                                    if ($row = mysqli_fetch_array($getimage)) {
                                            ...
                                            <div class="card shadow mb-3">
                                                ...
                                                <div class="card-body">
                                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <div class="form-group"><label for="email"><strong>
                                                                            Address</strong></label><input class="form-control" type="text" placeholder="user@example.com" value="<?php echo $address ?>" name="address">
                                                                </div>
                                                        ...
                                                        <div class="form-group"><button class="btn btn-primary btn-sm" type="submit" name="btnSavePersonal">Save
                                                                Settings</button>
                                                        </div>
                                                    </form>
