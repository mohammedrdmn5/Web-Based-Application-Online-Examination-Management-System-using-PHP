...
if (isset($_POST['Submitdata'])) {
    ...
    for ($x = 0; $x < $questions; $x++) {
        ...
        $queryToStudentRec = mysqli_query($conn, "INSERT INTO student_record (user_id, exam_id, question_id, answer, mark)  VALUES ('$user_id','$exam_id1',,,,)") or die(mysqli_error($conn));
