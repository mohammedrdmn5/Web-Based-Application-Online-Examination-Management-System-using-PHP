            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                <p class="text-primary m-2 font-weight-bold" style="margin:auto;font-size:25px !important;"><?php if(isset($_SESSION['username'])){
                                ...
                                <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" <?php $pic = 'null.png';
                                    ...
                                    <div class="mb-3"><button class="btn btn-primary btn-sm" name="changepicture" type="button">Change Photo</button></div>
                                </div>
                            </div>
