                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="Resetpassword.php">
                                        ...
                                        <div class="form-group"><input class="form-control form-control-user" value="<?php echo $password; ?>" type="number" id="exampleInputPassword" placeholder="Phone number" name="Phone"></div>
