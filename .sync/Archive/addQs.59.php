                                    ...
                                    if (isset($_GET['search'])) {
                                        ...
                                        while ($row = $searchResult->fetch_assoc()) {
                                            ...
                                            for ($i = 0; $i < $numberOfQs; $i++) {
                                                ...
                                                echo
                                                '<tr><td>  <input type="text" name="question_title" class="form-control"  required placeholder="Enter your question title" value=""></td>';
                                                echo '<td>';
                                                for ($option = 0; $option < 4; $option++) {
                                                    echo '<input type="text" name="opetion_title" class="form-control" style="margin:10px" required placeholder="Enter the NO.' . $option + 1 . ' option title" value="">';
                                                }
                                                echo '</td>';
                                                echo '<td>
                                                <label>Select correct opetion NO.&nbsp; <select class="form-control form-control-sm custom-select custom-select-sm" name="answer_option" style="width:fit-content;">
                                                ...
                                                ';
                                                echo '<td>
                                                <input type="text" name="opetion_title" class="form-control" style="margin:10px" required placeholder="Enter the marks" value="">
                                                </td>
                                                ';
