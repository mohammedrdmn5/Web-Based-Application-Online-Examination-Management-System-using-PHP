                                        ...
                                        <<input type="hidden" name="id" value="<?php echo $exam_id; ?>">
                                            <div class="input-group" style="padding-top: 20px;">
                                                <input type="text" name="exam_title" class="form-control" placeholder="Enter exam title" value="<?php echo $exam_title;
                                                                                                                                                ?>">
                                                <input type="date" data-type="datetime" min="<?php echo date('Y-m-d'); ?>" name="exam_datetime" class="form-control" placeholder="Enter exam datetime" value="<?php echo $exam_datetime;
                                                                                                                                                                                                                ?>">
