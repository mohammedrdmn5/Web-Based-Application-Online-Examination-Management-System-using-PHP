...
if(isset($_POST['Submitdata'])){
   ...
   for($x=0;$x<$questions;$x++){
       $_REQUEST['']
        ...
        $success = mysqli_query($conn, "INSERT INTO question (question_title, answer_option, mark, exam_id ) VALUES ('$question_title.$x','$answer_option.$x','$mark.$x','$','$status','$course_id[0]','$teacher_id','$faculty_id[0]','$exam_code')") or die(mysqli_error($conn));
        if ($success) {
