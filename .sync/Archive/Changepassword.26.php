                            ...
                            <div class="row">
                                <div class="col-lg-6 d-none d-lg-flex">
                                    <div class="flex-grow-1 bg-login-image"
                                        style="background-image: url(&quot;assets/img/1566798061-exam-online.png&quot;);">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <form class="user" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                            ...
                                            <div class="form-group"><input class="form-control form-control-user"
                                                    value="<?php if (isset($_SESSION['Random_pass'])) {
                                                                                                                                echo $_SESSION['Random_pass'];
                                                                                                                                unset($_SESSION['Random_pass']);
                                                                                                                            } else {
                                                                                                                                echo $currentpwd;
                                                                                                                            } ?>" class="form-control" type="password"
                                                    name="curr-pass" placeholder="Current password" minlength="1"
                                                    maxlength="25" required>
                                            </div>
                                            <div class="form-group"><input class="form-control form-control-user"
                                                    value="<?php echo $newpwd; ?>" class="form-control" type="password"
                                                    name="new-pass" placeholder="New password" minlength="1"
                                                    maxlength="25" required>
                                            </div>
                                            <div class="form-group"><input class="form-control form-control-user"
                                                    value="<?php echo $confirmpwd; ?>" class="form-control"
                                                    type="password" name="new-confirm-pass"
                                                    placeholder="Confirm new password" minlength="1" maxlength="25"
                                                    required>
                                            </div>

                                            <button class="btn btn-primary btn-block text-white btn-user" name="submit"
                                        ...
                                        ?>
                                        <div class="text-center"><a class="small" href="Dashboard.php">Go back to online
                                                Examination</a></div>
                                        <?php
                                        } else {
                                        ?>
