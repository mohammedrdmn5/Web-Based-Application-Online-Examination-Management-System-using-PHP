                        ...
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                ...
                                <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4"
                                    ...
                                    <div class="mb-3">
                                        <button class="btn btn-primary btn-sm" name="changepicture" type="button">Change
                                            Photo</button>
                                        <input class="btn-primary " type="file" id="myFile" name="filename">
                            ...
                            function changePhoto()
                            {
                                if (isset($_POST['filename'])) {
                                    ...
                                    $query = "UPDATE User SET address='$user_image' where user_id = '$user_id'";
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div class="form-group"><label for="email"><strong>
                                                                ...
                                                                value="<?php echo $address ?>" name="address"></div>
