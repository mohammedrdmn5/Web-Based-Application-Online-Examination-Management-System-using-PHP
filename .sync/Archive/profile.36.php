                                        ...
                                        <div class="col">
                                            <div class="card text-white bg-primary shadow">
                                                <div class="card-body">
                                                    ...
                                                    <p class="text-white-50 small m-0"><i
                                                            class="fas fa-arrow-up"></i>&nbsp;5%
                                                        since last month</p>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="card-body">
                                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                                        <div class="form-row">
                                                            <div class="col">
                                                                <div class="form-group"><label
                                                                        ...
                                                                        placeholder="John" value="<?php echo $fName ?>"
                                                                        name="fname"></div>
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group"><label
                                                                        for="last_name"><strong>Last
                                                                            Name</strong></label><input
                                                                        class="form-control" type="text"
                                                                        placeholder="Doe" value="<?php echo $lName ?>"
                                                                        name="lname"></div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col">
                                                                <div class="form-group"><label
                                                                        for="mobile_No"><strong>Mobile
                                                                            No</strong></label><input
                                                                        class="form-control" type="text"
                                                                        placeholder="01805151"
