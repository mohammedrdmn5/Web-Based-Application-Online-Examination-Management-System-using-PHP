                                ...
                                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                    ...
                                    <table class="table my-0" id="dataTable">
                                        ...
                                        if (isset($_GET['search'])) {
                                            ...
                                            ';
                                            $question_table = $conn->query("SELECT DISTINCT *,
                                             COUNT(exam.exam_id) AS Qus 
                                              FROM question
                                                  LEFT OUTER JOIN exam
                                                    ON question.exam_id = exam.exam_id
                                                  LEFT OUTER JOIN question_opetions
                                            ...
                                            while ($row = $searchResult->fetch_assoc() && $tableQ = mysqli_fetch_array($question_table)) {
                                                ...
                                                for ($i = 0; $i < $numberOfQs; $i++) {
                                                    ...
                                                    '<tr>
                                                    <td> 
                                                    <label name="question_title' . $i . '"> Question No. ' . $i . ' <br/>   '. $tableQ['question_title'].'</label>
                                                     <input type="text" name="question_title' . $i . '" class="form-control"  required placeholder="Enter your question title" value="">
                                                    </td>';
                                                    echo '<td>';
