                        ...
                        <div class="col-lg-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                            <button class="btn btn-primary btn-sm" name="changepicture" type="submit">Change
                                                Photo</button>
                                            <input class="btn-primary " type="File" id="filename" name="filename">
                                        </form>
                            ...
                            function changePhoto()
                            {
                                if (isset($_POST['filename'])) {
                                    ...
                                    // Uploads files
                                    $filename = rand(1000, 10000) . "-" . $_FILES["filename"]["name"];
                                    $temp_sfile = $_FILES["filename"]["tmp_name"];
                                    $dir = './assets/img';
                                    move_uploaded_file($temp_sfile, $dir . '/' . $filename);
                                    /////////////
                                    $query = "UPDATE User SET address='$filename' where user_id = '$user_id'";
