...
if (isset($_POST['save'])) {
    ...
    $exam_title =  mysqli_real$_POST['exam_title']);
    $exam_datetime = $conn->$_POST['exam_datetime'];
    $exam_duration = mysqli_real$_POST['exam_duration']);
    $total_question = mysqli_real$_POST['total_question']);
    $status = mysqli_real$_POST['status']);
    $course_title = mysqli_real$_POST['course_title']);
    $faculty_title = mysqli_real$_POST['faculty_title']);
    $fullname = mysqli_real$_POST['fullname']);
    $exam_code = mysqli_real$_POST['exam_code']);
