                                    ...
                                    <form action="process.php" method="POST">
                                        ...
                                        <div class="input-group" style="padding-top: 20px;">
                                            ...
                                            <select class="form-control" id="sel1" name="course_title">
                                                ...
                                                <?php
                                                $address_Id = GetDataFromDataBase("SELECT DISTINCT address_id FROM address ORDER BY address_id");
                                                while ($data = mysqli_fetch_array($address_Id))
                                                    ShowDataToDorpDownlist($data['address_id']);
                                                ?>
