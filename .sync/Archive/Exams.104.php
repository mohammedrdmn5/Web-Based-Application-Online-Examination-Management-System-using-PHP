...
{
    if (isset($data_id) && $data_id == $data_id) {
                                    ...
                                    <form action="process.php" method="POST" style="width:1550px">
                                        ...
                                        <div class="input-group" style="padding-top: 20px;">
                                            ...
                                            <select class="form-control" id="sel1" name="faculty_title">
                                                <option value="">SELECT course title</option>
                                                <?php
                                                $course_data = GetDataFromDataBase("SELECT DISTINCT * FROM faculty");
                                                while ($data = mysqli_fetch_array($course_data))
                                            ...
                                            <select class="form-control" id="sel1" name="faculty_title">
                                                <option value="">SELECT course title</option>
                                                <?php
                                                $course_data = GetDataFromDataBase("SELECT DISTINCT  *,  CONCAT(fname , ' ', lname) AS full name FROM user ");
                                                while ($data = mysqli_fetch_array($course_data))
