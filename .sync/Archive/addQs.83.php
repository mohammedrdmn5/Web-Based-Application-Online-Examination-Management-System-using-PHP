...
if(isset($_POST['Submitdata'])){
   ...
   for($x=0;$x<$questions;$x++){
        ...
        $success = mysqli_query($conn, "INSERT INTO question_opetions (question_id, opetion_title, opetion_number) VALUES ('$question_title.$x','$answer_option.$x','$mark.$x','$exam_id1')") or die(mysqli_error($conn));
        if ($success) {
