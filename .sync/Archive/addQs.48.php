                                        ...
                                        while ($row = $searchResult->fetch_assoc()) {
                                            ...
                                            for ($i = 0; $i < $numberOfQs; $i++) {
                                                ...
                                                for ($option = 0; $option < 4; $option++) {
                                                   echo ' <label for="opetion_title">'. $option. '</label><input type="text" name="opetion_title" class="form-control" style="margin-left:10px" required placeholder="Enter exam title" value="">';
                                                }
