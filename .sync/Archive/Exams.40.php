                                ...
                                <div class="col-md-6 text-nowrap">
                                    <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable">
                                        <label>Select&nbsp; <select class="form-control form-control-sm custom-select custom-select-sm" name="category" style="width:fit-content;">
                                                <option value="fName" selected>exam title</option>
                                                <option value="lName">exam datetime</option>
                                                <option value="email">total question</option>
                                                <option value="phone">created on</option>
                                                <option value="joined_at">course title</option>
                                                <option value="role_name">faculty title</option>
                                                <option value="role_name">teacher name</option>
                                                <option value="role_name">exam code</option>
                                            </select>&nbsp;</label>&nbsp;&nbsp;
