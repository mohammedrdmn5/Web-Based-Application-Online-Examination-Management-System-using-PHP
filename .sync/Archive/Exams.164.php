                                        ...
                                        <form action="process.php" method="POST" id="formsave" style="min-width:1550px;">
                                            ...
                                            <div class="input-group" style="padding-top: 20px;">
                                                <input type="text" name="exam_title" class="form-control" required placeholder="Enter exam title" value="<?php echo $exam_title;
                                                                                                                                                            ?>">
                                                <input type="datetime-local" data-type="datetime" min="<?php echo date('Y-m-d\TH:i'); ?>" required name="exam_datetime" class="form-control" placeholder="Enter exam datetime" value="<?php echo $exam_datetime;
                                                                                                                                                                                                                                        ?>">
                                        ...
                                        while ($row = $searchResult->fetch_assoc()) {
                                            ...
                                            echo '
                                                <tr>
                                                    ...
                                                    <td>' . $row['exam_code'] . '</td>
                                                    <td>
                                                    <a style="padding:5px;" href="./Exams.php?addQ=' . $row['exam_id'] . '"
                                                    class ="btn btn-success">Add questions</a> <br />
                                                    <a style="padding:5px;" href="./Exams.php?edit=' . $row['exam_id'] . '"
                                                    class ="btn btn-info">Edit</a>
                                                    <a style="padding:5px;" href="./Exams.php?delete=' . $row['exam_id'] . '"
                                                    class ="btn btn-danger">Delete</a>
                                                    </td>
                                                </tr>                                                
                                                ';
