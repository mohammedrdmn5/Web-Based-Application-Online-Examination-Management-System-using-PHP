...
if (isset($_POST['Submitdata'])) {
    ...
    for ($x = 0; $x < $questions; $x++) {
        ...
        if ($success) {
            ...
            $success2 = mysqli_query($conn, "INSERT INTO question_opetions (question_id, opetion_title, opetion_number) VALUES ('$question_id[$x]','$answer_option.$x','$mark.$x','$exam_id1')") or die(mysqli_error($conn));
