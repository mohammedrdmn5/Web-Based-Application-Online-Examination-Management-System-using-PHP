                            ...
                            <div class="row">
                                <div class="col-md-6 text-nowrap">
                                    <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable">
                                        <label>Select&nbsp;<select class="form-control form-control-sm custom-select custom-select-sm">
                                ...
                                <div class="col-md-6 text-nowrap">
                                    ...
                                    <select class="form-control form-control-sm custom-select custom-select-sm" name="category" style="width:fit-content;">
