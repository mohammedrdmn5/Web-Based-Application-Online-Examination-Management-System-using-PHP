                                    ...
                                    if (isset($_GET['search'])) {
                                        ...
                                        while ($row = $searchResult->fetch_assoc()) {
                                            ...
                                            for ($i = 0; $i < $numberOfQs; $i++) {
                                                ...
                                                echo
                                                '<tr><td>  <input type="text" name="exam_title" class="form-control" required placeholder="Enter exam title" value=""></td>';
                                                echo'<td>';
                                                for ($option = 0; $option < 4; $option++) {
                                                   echo ' <label for="opetion_title">'. $option+1 . '</label><input type="text" name="opetion_title" class="form-control" style="margin-left:10px" required placeholder="Enter exam title" value="">';
                                                }
