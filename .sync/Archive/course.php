                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_POST['btnSearch'])) {
                                            ...
                                            $courseData = mysqli_query($conn, "SELECT `course`.`course_id`, `course`.`course_title`, `faculty`.`faculty_title`, `user`.`fname`, `user`.`lname` FROM `course`  LEFT JOIN `faculty` ON `course`.`faculty_id` = `faculty`.`faculty_id`, `user` where `course`.`course_title` LIKE '$searchTarget';") or die(mysqli_error($conn));
